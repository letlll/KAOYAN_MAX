---
title: "Obsidian 插件：Longform 如何使用 Obsidian 完成一本自己的小说创作-Pkmer"
source: "https://pkmer.cn/Pkmer-Docs/10-obsidian/obsidian%E7%A4%BE%E5%8C%BA%E6%8F%92%E4%BB%B6/longform/"
author:
  - "[[OS]]"
published: 2024-04-26
created: 2024-11-23
description: "Longform是Obsidian的一个插件，帮助你撰写和编辑小说、剧本和其他长篇作品。它可以将一系列笔记（即“场景”）组织成有序的手稿，并支持较短作品的单个笔记项目。主要功能包括：专用侧边栏，收集来自整个存储库的项目；可重排、可嵌套的场景列表；场景/草稿/项目的字数统计；每日写作会话目标，提供多种选项以适应你的写作风格；基于工作流的编译工具，可以从项目中创建手稿；支持单场景项目，使较短作品可以使用与较长作品相同的工作流和工具；以及许多命令、模态框和菜单项，帮助你管理工作。"
tags:
  - "clippings"
---
obsidian社区插件
...
插件ID：longform longform longform：Obsidian 插件：Longform 如何使用 Obsidian 完成一本自己的小说创作

Longform是Obsidian的一个插件，帮助你撰写和编辑小说、剧本和其他长篇作品。它可以将一系列笔记（即“场景”）组织成有序的手稿，并支持较短作品的单个笔记项目。主

Longform是Obsidian的一个插件，帮助你撰写和编辑小说、剧本和其他长篇作品。它可以将一系列笔记（即“场景”）组织成有序的手稿，并支持较短作品的单个笔记项目。主要功能包括：专用侧边栏，收集来自整个存储库的项目；可重排、可嵌套的场景列表；场景/草稿/项目的字数统计；每日写作会话目标，提供多种选项以适应你的写作风格；基于工作流的编译工具，可以从项目中创建手稿；支持单场景项目，使较短作品可以使用与较长作品相同的工作流和工具；以及许多命令、模态框和菜单项，帮助你管理工作。
...
【Obsidian Longform：一个你寻找已久的长文档编辑插件】 https://www.bilibili.com/video/BV1yr421J7Qa/?share_source=copy_web&vd_source=07ea92b70407ff2a13a4ae38e23d7d4d


- ![Obsidian Longform：一个你寻找已久的长文档编辑插件 - 00:31|450](assets/Obsidian%20Longform：一个你寻找已久的长文档编辑插件PT31.061S.webp) [00:31](https://www.bilibili.com/video/BV1yr421J7Qa/?t=31.060572#t=31.06) 


应用场景
：需要写很多东西，然后讲一个长而大的文件进行分割。

![](assets/Pasted%20image%2020241123142710.png)

- 字数设置


- ![Obsidian Longform：一个你寻找已久的长文档编辑插件 - 01:36|450](assets/Obsidian%20Longform：一个你寻找已久的长文档编辑插件PT1M36.601S.webp) [01:36](https://www.bilibili.com/video/BV1yr421J7Qa/?t=96.600767#t=01:36.60) 
- 
- ![Obsidian Longform：一个你寻找已久的长文档编辑插件 - 02:05|450](assets/Obsidian%20Longform：一个你寻找已久的长文档编辑插件PT2M5.375S.webp) [02:05](https://www.bilibili.com/video/BV1yr421J7Qa/?t=125.374705#t=02:05.37) 



- ![Obsidian Longform：一个你寻找已久的长文档编辑插件 - 02:26|450](assets/Obsidian%20Longform：一个你寻找已久的长文档编辑插件PT2M26.883S.webp) [02:26](https://www.bilibili.com/video/BV1yr421J7Qa/?t=146.883215#t=02:26.88) 